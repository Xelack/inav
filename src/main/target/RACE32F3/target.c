...
const timerHardware_t timerHardware[] = {    
    ...
    DEF_TIM(TIM3,   CH1,    PB4,    TIM_USE_PWM,                                                0), // RC_CH3
    DEF_TIM(TIM3,   CH2,    PB5,    TIM_USE_PWM,                                                0), // RC_CH4
    DEF_TIM(TIM3,   CH3,    PB0,    TIM_USE_PWM | TIM_USE_MC_SERVO,                             0), // RC_CH5
    DEF_TIM(TIM3,   CH4,    PB1,    TIM_USE_PWM | TIM_USE_MC_SERVO,                             0), // RC_CH6
    DEF_TIM(TIM2,   CH4,    PB11,   TIM_USE_PWM | TIM_USE_MC_SERVO,                             0), // RC_CH7
    DEF_TIM(TIM2,   CH3,    PB10,   TIM_USE_PWM | TIM_USE_MC_SERVO,                             0), // RC_CH8
};
